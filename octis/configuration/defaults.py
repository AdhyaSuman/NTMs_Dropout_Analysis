...
metric_parameters = {
    ...
    # classification
    "PrecisionScore": {"name": "PrecisionScore", "module": "classification_metrics",
                "dataset": {"type": "String", "default_value": "use selected dataset"},
                'average': {"type": "Categorical", "default_value": "micro",
                            "possible_values": ['binary', 'micro', None, 'macro', 'samples', 'weighted']
                            }},
    ...
    # classification
    "RecallScore": {"name": "RecallScore", "module": "classification_metrics",
                "dataset": {"type": "String", "default_value": "use selected dataset"},
                'average': {"type": "Categorical", "default_value": "micro",
                            "possible_values": ['binary', 'micro', None, 'macro', 'samples', 'weighted']
                            }},
    # classification
    "AccuracyScore": {"name": "AccuracyScore", "module": "classification_metrics",
                "dataset": {"type": "String", "default_value": "use selected dataset"},
                'average': {"type": "Categorical", "default_value": "micro",
                            "possible_values": ['binary', 'micro', None, 'macro', 'samples', 'weighted']
                            }}
