...
class ETM(BaseETM):
    ...
    def __init__(self, num_topics=10, num_epochs=100, t_hidden_size=800, rho_size=300, embedding_size=300,
                 activation='relu', theta_dropout=0.2, enc_dropout=0.2, lr=0.005, optimizer='adam', batch_size=128, clip=0.0,
                 wdecay=1.2e-6, bow_norm=1, device='cpu', top_word=10, train_embeddings=True, embeddings_path=None,
                 embeddings_type='pickle', binary_embeddings=True, headerless_embeddings=False, use_partitions=True, use_validation=True):
        """
    ...
    def set_model(self, dataset, hyperparameters):
        ...
        self.model = etm.ETM(num_topics=self.hyperparameters['num_topics'],
                             ...
                             enc_drop=self.hyperparameters['enc_dropout'],
                             theta_drop=self.hyperparameters['theta_dropout'],
                             ).to(self.device)
