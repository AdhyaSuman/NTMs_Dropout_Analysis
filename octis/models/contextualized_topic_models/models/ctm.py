...
class CTM(object):
    ...
    def __init__(self, input_size, bert_input_size, inference_type="zeroshot", num_topics=10, model_type='prodLDA',
                 hidden_sizes=(100, 100), activation='softplus', theta_dropout=0.2, enc_dropout=0.2, learn_priors=True, batch_size=64,
    ...
    def fit(self, train_dataset, validation_dataset=None, save_dir=None, verbose=True):
        ...
        if verbose:
            print("Settings: \n\
                ...
                self.hidden_sizes, self.activation, self.enc_dropout, self.theta_dropout,
                self.learn_priors, self.lr, self.momentum, self.reduce_on_plateau, save_dir))
