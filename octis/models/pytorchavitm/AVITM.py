...
class AVITM(AbstractModel):
    ...
    def set_params(self, hyperparameters):
        ...
        self.hyperparameters['theta_dropout'] = float(hyperparameters.get('theta_dropout', self.hyperparameters['theta_dropout']))
        self.hyperparameters['enc_dropout'] = float(hyperparameters.get('enc_dropout', self.hyperparameters['enc_dropout']))
